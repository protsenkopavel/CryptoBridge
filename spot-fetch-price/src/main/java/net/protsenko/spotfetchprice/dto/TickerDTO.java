...
public record TickerDTO(
    ...
    public static TickerDTO fromKucoinTicker(AllTickersTickerResponse ticker) {
    ...
    public static TickerDTO fromBitfinexV2Ticker(org.knowm.xchange.bitfinex.v2.dto.marketdata.BitfinexTicker ticker) {
        if (ticker == null) {
            return null;
        }
    ...
    private static CurrencyPair parseBitfinexSymbol(String symbol) {
    ...
    public static CurrencyPair parseKucoinSymbol(String symbol) {
